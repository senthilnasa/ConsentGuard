...
Privacy & Consent Manager turns your WordPress site into a single, centralized privacy layer:
...
1. Upload the `privacy-consent-manager` folder to `/wp-content/plugins/`, or install via Plugins → Add New.
2. Activate the plugin.
3. Go to **Privacy & Consent → Consent Banner** and configure text and design.
4. Add your IDs under **Privacy & Consent → Analytics** (GA4 Measurement ID, Clarity Project ID, Cloudflare token, GTM container).
5. Run **Privacy & Consent → Cookie/Script Scanner → Scan Now** and review conflicts under **Plugin Conflicts**.
