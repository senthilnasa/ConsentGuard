...
<?php if ( 'ga4' === $pcm_tab ) : ?>
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td><label><input type="hidden" name="pcm[ga4][enabled]" value="" /><input type="checkbox" name="pcm[ga4][enabled]" value="1" <?php checked( $settings['ga4']['enabled'] ); ?> /> <?php esc_html_e( 'Load GA4 (gtag.js) after consent', 'privacy-consent-manager' ); ?></label></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label><input type="hidden" name="pcm[ga4][anonymize_ip]" value="" /><input type="checkbox" name="pcm[ga4][anonymize_ip]" value="1" <?php checked( $settings['ga4']['anonymize_ip'] ); ?> /> <?php esc_html_e( 'Send anonymize_ip with the GA4 config', 'privacy-consent-manager' ); ?></label></td>
		</tr>
	</table>
	...
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><?php esc_html_e( 'Enable', 'privacy-consent-manager' ); ?></th>
			<td>
				<label><input type="hidden" name="pcm[consent_mode][enabled]" value="" /><input type="checkbox" name="pcm[consent_mode][enabled]" value="1" <?php checked( $settings['consent_mode']['enabled'] ); ?> /> <?php esc_html_e( 'Set default denied consent signals before Google tags initialize and send updates when the visitor decides', 'privacy-consent-manager' ); ?></label>
		...
		<tr>
			...
			<td><label><input type="hidden" name="pcm[consent_mode][ads_data_redaction]" value="" /><input type="checkbox" name="pcm[consent_mode][ads_data_redaction]" value="1" <?php checked( $settings['consent_mode']['ads_data_redaction'] ); ?> /> <?php esc_html_e( 'Redact ad click identifiers while ad_storage is denied', 'privacy-consent-manager' ); ?></label></td>
		</tr>
		<tr>
			<th scope="row"><?php esc_html_e( 'URL passthrough', 'privacy-consent-manager' ); ?></th>
			<td><label><input type="hidden" name="pcm[consent_mode][url_passthrough]" value="" /><input type="checkbox" name="pcm[consent_mode][url_passthrough]" value="1" <?php checked( $settings['consent_mode']['url_passthrough'] ); ?> /> <?php esc_html_e( 'Pass ad click information through URLs while consent is denied', 'privacy-consent-manager' ); ?></label></td>
		</tr>
	</table>
...
<?php elseif ( 'clarity' === $pcm_tab ) : ?>
	...
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><?php esc_html_e( 'Enable', 'privacy-consent-manager' ); ?></th>
			<td><label><input type="hidden" name="pcm[clarity][enabled]" value="" /><input type="checkbox" name="pcm[clarity][enabled]" value="1" <?php checked( $settings['clarity']['enabled'] ); ?> /> <?php esc_html_e( 'Load Microsoft Clarity after consent', 'privacy-consent-manager' ); ?></label></td>
		</tr>
		<tr>
...
<?php elseif ( 'cloudflare' === $pcm_tab ) : ?>
	...
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><?php esc_html_e( 'Enable', 'privacy-consent-manager' ); ?></th>
			<td><label><input type="hidden" name="pcm[cloudflare][enabled]" value="" /><input type="checkbox" name="pcm[cloudflare][enabled]" value="1" <?php checked( $settings['cloudflare']['enabled'] ); ?> /> <?php esc_html_e( 'Load the Cloudflare Web Analytics beacon', 'privacy-consent-manager' ); ?></label></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<label><input type="hidden" name="pcm[cloudflare][require_consent]" value="" /><input type="checkbox" name="pcm[cloudflare][require_consent]" value="1" <?php checked( $settings['cloudflare']['require_consent'] ); ?> /> <?php esc_html_e( 'Require consent before loading the beacon', 'privacy-consent-manager' ); ?></label>
...
<?php else : ?>
	...
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><?php esc_html_e( 'Enable', 'privacy-consent-manager' ); ?></th>
			<td><label><input type="hidden" name="pcm[gtm][enabled]" value="" /><input type="checkbox" name="pcm[gtm][enabled]" value="1" <?php checked( $settings['gtm']['enabled'] ); ?> /> <?php esc_html_e( 'Load GTM after consent', 'privacy-consent-manager' ); ?></label></td>
		</tr>
		<tr>
