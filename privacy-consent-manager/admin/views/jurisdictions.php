...
Admin::maybe_notice();
?>
<h1><?php esc_html_e( 'Jurisdiction Rules', 'privacy-consent-manager' ); ?></h1>
...
<table class="form-table" role="presentation">
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Default profile', 'privacy-consent-manager' ); ?></th>
		<td>
...
<h2><?php esc_html_e( 'Country → Profile rules', 'privacy-consent-manager' ); ?></h2>
<table class="widefat striped pcm-table" style="max-width:560px">
	<thead>
		<tr>
			<th><?php esc_html_e( 'Country code (ISO 3166-1 alpha-2)', 'privacy-consent-manager' ); ?></th>
...
<p class="description"><?php esc_html_e( 'EU/EEA countries automatically map to the GDPR profile unless overridden. Clear a country code to remove its rule.', 'privacy-consent-manager' ); ?></p>

<h2><?php esc_html_e( 'Profiles', 'privacy-consent-manager' ); ?></h2>
...
<h2><?php esc_html_e( 'India / DPDP Configuration', 'privacy-consent-manager' ); ?></h2>
<p class="description"><?php esc_html_e( 'These texts are shown to visitors matched to the DPDP profile. Nothing is hard-coded — adapt the wording to your organization\'s actual data processing and legal advice.', 'privacy-consent-manager' ); ?></p>
<table class="form-table" role="presentation">
	<tr>
		<th scope="row"><label for="pcm-dpdp-notice"><?php esc_html_e( 'Notice text', 'privacy-consent-manager' ); ?></label></th>
	...
	<tr>
		<th scope="row"><label for="pcm-dpdp-purpose"><?php esc_html_e( 'Purpose descriptions', 'privacy-consent-manager' ); ?></label></th>
	...
	<tr>
		<th scope="row"><label for="pcm-dpdp-rights"><?php esc_html_e( 'User rights information', 'privacy-consent-manager' ); ?></label></th>
	...
	<tr>
		<th scope="row"><label for="pcm-dpdp-contact"><?php esc_html_e( 'Contact email', 'privacy-consent-manager' ); ?></label></th>
	...
	<tr>
		<th scope="row"><label for="pcm-dpdp-grievance"><?php esc_html_e( 'Grievance / contact information', 'privacy-consent-manager' ); ?></label></th>
