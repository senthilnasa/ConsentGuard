...
class Settings {
	...
	public static function defaults() {
		return array(
			...
			'banner'        => array(
				...
				'layout'            => 'bar',          // bar | box.
				'title'             => __( 'We value your privacy', 'privacypress' ),
				'message'           => __( 'We use cookies and similar technologies to improve your experience, understand website usage and support our services.', 'privacypress' ),
				'accept_label'      => __( 'Accept All', 'privacypress' ),
				'reject_label'      => __( 'Reject All', 'privacypress' ),
				'manage_label'      => __( 'Manage Preferences', 'privacypress' ),
				'save_label'        => __( 'Save Preferences', 'privacypress' ),
				'reopen_label'      => __( 'Privacy Settings', 'privacypress' ),
				'show_close'        => false,
				'show_reject'       => true,
				'reopen_button'     => true,
				'logo_url'          => '',
	...
	public static function default_categories() {
		return array(
			'necessary'   => array(
				'label'       => __( 'Necessary', 'privacypress' ),
				'description' => __( 'Required for the website to function. Cannot be disabled.', 'privacypress' ),
				'required'    => true,
				'builtin'     => true,
			),
			'functional'  => array(
				'label'       => __( 'Functional', 'privacypress' ),
				'description' => __( 'Enables enhanced functionality such as embedded media and live chat.', 'privacypress' ),
				'required'    => false,
				'builtin'     => true,
			),
			'analytics'   => array(
				'label'       => __( 'Analytics', 'privacypress' ),
				'description' => __( 'Helps us understand how visitors use the website (e.g. Google Analytics, Microsoft Clarity).', 'privacypress' ),
				'required'    => false,
				'builtin'     => true,
			),
			'marketing'   => array(
				'label'       => __( 'Marketing', 'privacypress' ),
				'description' => __( 'Used for advertising, remarketing and measuring ad performance.', 'privacypress' ),
				'required'    => false,
				'builtin'     => true,
			),
			'preferences' => array(
				'label'       => __( 'Preferences', 'privacypress' ),
				'description' => __( 'Remembers optional personalization choices such as language or region.', 'privacypress' ),
				'required'    => false,
				'builtin'     => true,
			),
		);
	...
	public static function default_profiles() {
		return array(
			'gdpr'      => array(
				'label'           => __( 'EU / EEA (GDPR)', 'privacypress' ),
				'require_consent' => true,
			...
			'uk_gdpr'   => array(
				'label'           => __( 'United Kingdom (UK GDPR)', 'privacypress' ),
				'require_consent' => true,
				'show_reject_all' => true,
				'granular'        => true,
				'mode'            => 'opt_in',
			...
			'dpdp'      => array(
				'label'           => __( 'India (DPDP Act)', 'privacypress' ),
				'require_consent' => true,
				'show_reject_all' => true,
				'granular'        => true,
				'mode'            => 'opt_in',
			...
			'us_optout' => array(
				'label'           => __( 'US-style (opt-out)', 'privacypress' ),
			...
			'default'   => array(
				'label'           => __( 'Default (rest of world)', 'privacypress' ),
				'require_consent' => true,
				'show_reject_all' => true,
				'granular'        => true,
				'mode'            => 'opt_in',
